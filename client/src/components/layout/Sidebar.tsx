          ...
          <li>
            <Link href="/banking">
              <div className={`flex items-center py-2 px-4 rounded-md cursor-pointer ${
                ...
                <span className="text-green-700 dark:text-green-300 font-medium">Banking</span>
              </div>
            </Link>
          </li>
          ...
          <li>
            <Link href="/crypto-wallet">
              <div className={`flex items-center py-2 px-4 rounded-md cursor-pointer ${
                ...
                <span className="text-blue-700 dark:text-blue-300 font-medium">Crypto Wallet</span>
              </div>
            </Link>
          </li>
        ...
        <Link href="/login">
          <div className={`flex items-center py-2 px-4 rounded-md cursor-pointer mb-2 ${
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-3">
              <path d="M15 3h4a22 0 0 1 2 2v14a2 2 0 0 1 2 2h-4M10 17l5-5-5-5M13.8 12H3" />
            </svg>
            <span>Login</span>
