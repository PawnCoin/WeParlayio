...
export default function LiveStreamPlayer({
  ...
  // Preview timer for Bronze/Silver users
  useEffect(() => {
    ...
    <Card className={cn("relative overflow-hidden", className)}>
      ...
      <CardContent className="p-0">
        ...
        >
          ...
          {/* Quality Badge and Tier Indicator */}
          <div className="absolute top-4 right-4 flex items-center space-x-2">
            {/* Quality Badge */}
            <Badge 
              variant={quality === '4K' ? 'default' : quality === 'HD' ? 'secondary' : 'outline'}
              className={cn(
                "backdrop-blur-sm",
                quality === '4K' && "bg-gradient-to-r from-purple-600 to-pink-600",
                quality === 'HD' && "bg-gradient-to-r from-blue-600 to-cyan-600"
              )}
            >
              {quality}
            </Badge>
          ...
          {/* Preview Timer for Bronze/Silver */}
