...
// App component already has QueryClientProvider, no need to duplicate
import ThemeProvider from "./lib/ThemeProvider";
import { initWordPressSync } from "./lib/wordpressSync";
import { initializeTokenCleanup } from "./utils/tokenCleaner";
...
// Initialize token cleanup to handle malformed JWT tokens
