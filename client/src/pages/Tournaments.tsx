...
export default function Tournaments() {
  ...
  return <div className="mx-auto max-w-7xl space-y-5 p-4">
    ...
    <a href="https://kingengine.online" target="_blank" rel="noreferrer" className="block rounded-xl bg-black p-3 text-center font-bold text-amber-400">Tournament insight powered by KingEngine.online →</a>
