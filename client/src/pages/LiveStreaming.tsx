  ...
  const liveGames = useMemo((): StreamingGame[] => {
    ...
    const sportsNewsChannels = [
      ...
      },
      {
        ...
        status: 'live' as const,
        startTime: new Date().toISOString(),
        streamUrl: 'https://www.youtube.com/embed/21X5lGlDOfg?autoplay=1&mute=1',
        odds: { homeWin: 1.0, awayWin: 1.0 },
      ...
      },
      {
        ...
        status: 'live' as const,
        startTime: new Date().toISOString(),
        streamUrl: 'https://www.youtube.com/embed/uVzHeOW4lmE?autoplay=1&mute=1',
        odds: { homeWin: 1.0, awayWin: 1.0 },
      ...
      },
      {
        ...
        status: 'live' as const,
        startTime: new Date().toISOString(),
        streamUrl: 'https://www.youtube.com/embed/qABzOdWucJ8?autoplay=1&mute=1',
        odds: { homeWin: 1.0, awayWin: 1.0 },
