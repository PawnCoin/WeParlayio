...
(async () => {
  try {
    ...
    // Load channels from M3U playlist - disabled due to 451 error (unavailable in this region)
    ...
    console.log('⚠️ IPTV service initialization skipped - service unavailable in current region');
